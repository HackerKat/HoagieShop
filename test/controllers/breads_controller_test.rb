...
class BreadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bread" do
    assert_difference('Bread.count') do
      post breads_url, params: { bread: { amount: @bread.amount, name: @bread.name, size: @bread.size } }
    end
  ...
  test "should update bread" do
    patch bread_url(@bread), params: { bread: { amount: @bread.amount, name: @bread.name, size: @bread.size } }
